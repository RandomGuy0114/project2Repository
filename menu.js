  ...
  if (event.target.classList.contains('addToCart')) {
    ...
    if (input.value != 0) {
      ...
      if (modal.querySelector(`#${uid}`)) {
        ...
        // updating the total price of one item.
        ...
        modal.querySelector(`#${uid}`).remove()
        modal.innerHTML += `
        ...
        <h6 id="kuwantiti" style="float:left;" data-qnt="${kwtt}">Qty: ${kwtt}</h6>
        <p style="float:right; margin-bottom:0rem; padding-top:0rem;">Price: ${value}</p><br>
        <p id="total" style="float:right; margin-bottom:0rem; padding-top:0rem;" data-totall="${ddtotal}">Total Price: ${ddtotal}</p><br>
        ...
        // adding a new element in sidebar when the order is dont have a copy in sidebar.
        modal.innerHTML += `
        <div id="${uid}" class="col-12 pl-2 pr-4 mb-3">
